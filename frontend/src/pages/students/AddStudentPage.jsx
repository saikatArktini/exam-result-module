...
const AddStudentPage = () => {
  ...
  const handleSubmit = async (formData) => {
    try {
      ...
      setError(err.response?.data?.message || 'Failed to add student. Roll number might already exist.');
    } finally {
    ...
    <div className="p-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden max-w-4xl">
        <div className="p-8 border-b border-gray-100">
          ...
          <p className="text-gray-500 text-sm mt-1">Fill in the details below to register a new student.</p>
        </div>
